...
public class FirstPersonControls : MonoBehaviour
{
    ...
    public float lookSpeed; // Sensitivity of the camera movement/speed at which camera moves
    ...
    private void OnEnable() //Initializes and enables input actions, Listens for player inputs
    {
